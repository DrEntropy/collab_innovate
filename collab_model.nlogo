...
- Observe the effect of changing the mutation rate (explore vs exploit).
...
* For high 'success-rate' the model settles down into a (potentially punctuated) equilibrium where the agents all have the same 'idea' and yet innovation continues.  This doesn't seem realistic, so consider ways in which this behavior can be supressed. 
